...
Game.Input = {
    ...
    onTouchStart(e) {
        ...
        for(var i=0;i<e.changedTouches.length;i++){
            ...
            if(pos.x<sw*0.35&&!this.joystick.active){
                ...
                this.aim.active=true;this.aim.id=t.identifier;this.aim.x=pos.x;this.aim.y=pos.y;
    ...
    onTouchMove(e) {
        ...
        for(var i=0;i<e.changedTouches.length;i++){
            ...
            if(t.identifier===this.joystick.id&&this.joystick.active){
                var dx=pos.x-this.joystick.startX,dy=pos.y-this.joystick.startY;
            ...
            if(t.identifier===this.aim.id&&this.aim.active){this.aim.x=pos.x;this.aim.y=pos.y;}
        }
    },
    ...
    onTouchEnd(e) {
        ...
        for(var i=0;i<e.changedTouches.length;i++){
            ...
            if(t.identifier===this.aim.id){this.aim.active=false;this.aim.id=-1;}
        }
    },
    ...
    onMouseDown(e) {
        ...
        if(pos.x<sw*0.35){
            ...
            this.aim.active=true;this.aim.x=pos.x;this.aim.y=pos.y;
            this._pendingTaps.push(pos);
        }
    },
    ...
    onMouseMove(e) {
        ...
        if(this.aim.active){this.aim.x=pos.x;this.aim.y=pos.y;}
    },

    onMouseUp(e) {this._mouseDown=false;this.joystick.active=false;this.joystick.dx=0;this.joystick.dy=0;this.aim.active=false;},
